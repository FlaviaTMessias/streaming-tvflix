...
// Seção da página inicial (filmes com melhor classificação, próximos, tendências)
...
const homePageSections = [
    ...
    {
        title:"Filmes populares semanais",
...
const genreList = {
    //  crie uma string de gênero a partir de gênero_id, por exemplo: [23, 43] "Ação, Romance,"
...
const heroBanner = function ({results:movieList}){
    ...
    for(const [index,movie] of movieList.entries()){
        ...
        <span class="span">Assista agora</span>
        </a>
        </div>
    ...
    // Buscar dados para seções da página inicial (mais bem avaliados, futuros, tendências)
